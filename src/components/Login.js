    ...
    return (
        <div>
            ...
            <form
                ...
                className='p-5 absolute w-9/12 md:w-3/12 top-40 md:top-28 mx-auto left-0 right-0 flex flex-col justify-center items-center bg-black bg-opacity-70 shadow-xl hover:shadow-2xl rounded'>
